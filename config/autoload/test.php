...
//        'dsn' => 'smtp://smtptest-mailpit:587',
    ...
    'r' => [
        'handWrist' => [
            'dashboardUrl' => 'r-artsendashboard-test.engon.nl',
            //'encryptionKey' => getenv('R_HAND_WRIST_DASHBOARD_KEY'),
            'encryptionKeyName' => 'R_HAND_WRIST_DASHBOARD_KEY',
            'oauthClient' => 'r-applications',
        ],
    ],
    'sites' => [
        'allowed' => [
            [
                'url' => 'https://pulse-test-k8s.equipezorgbedrijven.nl',
            ],
            [
                'url' => 'https://_',
            ],
